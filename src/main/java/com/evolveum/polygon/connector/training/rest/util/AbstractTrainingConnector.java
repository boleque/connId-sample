...
import com.evolveum.polygon.connector.training.rest.api.RGroup;
import com.evolveum.polygon.connector.training.rest.api.RObject;
import com.evolveum.polygon.connector.training.rest.api.RUser;
 ...
 */
public abstract class AbstractTrainingConnector {

    private static final Log LOG = Log.getLog(AbstractTrainingConnector.class);
    ...
    /**
     * Method which translates a set of attributes from the IAM system to a RGroup object representation
     * which can be communicated back to the remote system. e.g. as a parameter of the remote interface
     * convenience methods.
     * @param uid the unique identifier of the group object which is being translated
     * @param attributes the set of attributes usually returned from the iam system which should be used to
     * create the RGroup object
     */
