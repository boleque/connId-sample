...
/**
 * The REST mapping interface for the remote endpoint '/rest/users'. Acts as a facade, hiding unneeded complexity
...
//    @GET
//    RObjects<RUser> list(@QueryParam("name") String name,
//                         @QueryParam("value") String value);

    /**
     * GET HTTP method which returns RObjects representing a list of RUser objects (JSON objects translated into convenient java objects),
     ...
     * @return the object representation of a Json array of User (RUser) objects
     */
    @GET
    RObjects<RUser> list(@QueryParam("query") String query);

    /**
     * GET HTTP method which returns a single RUser object (JSON object translated into a convenient java object),
    ...
    /**
     * POST HTTP method which is used to create a USER object on the remote system
     * @param user the user in RUser format (Object representation of a Json User Object)
    ...
    /**
     * DELETE HTTP method which is used to delete a USER object on the remote system
    ...
    /**
     * PUT HTTP method which is used tu update a USER object on the remote system
     * @param user the user in RUser format (Object representation of a Json User Object)
     * @return the unique identifier of the created object
     */
    @PUT
     ...
     * @return the latest updates to objects of the User object type starting after the provided timestamp
     ...
     * @return the latest sync token representing the time when the last change occurred on the remote system to the User
     * object type
     */
    @GET
    @Path("/sync/token")
